...
public class FossilBirthDeathTreeDTToBEAST implements
        GeneratorToBEAST<FossilBirthDeathTreeDT, SABirthDeathModel> {

    public static final String suffix = ".origin";

    @Override
    public SABirthDeathModel generatorToBEAST(FossilBirthDeathTreeDT generator, BEASTInterface tree, BEASTContext context) {
        ...
        saBirthDeathModel.setInputValue("rho", context.getAsRealScalar(generator.getRho()));
    ...
    @Override
    public void modifyBEASTValues(FossilBirthDeathTreeDT generator, BEASTInterface tree, BEASTContext context) {
    ...
    @Override
    public Class<FossilBirthDeathTreeDT> getGeneratorClass() {
        return FossilBirthDeathTreeDT.class;
    }
